...
@section('title')
    <title>::Mr.Gift-Admin::Occasion Listings</title>
@endsection
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title mb-0">Occasion Listings</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Occasion Listings
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Occasion Listings</h4>
                                        ...
                                        <table class="table table-striped table-bordered dataex-html5-selectors">
                                            ...
                                            @foreach($types as $type)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('admin.occasion.edit',['id'=>$type->id])}}"
                                                           class="btn-sm btn-default btn-xs" data-toggle="tooltip" data-placement="top"
                                                           title="Edit"><i class="fa fa-pencil"></i></a>
                                                        <a href="{{route('admin.occasion.delete',['id'=>$type->id])}}"
