...
@section('title')
    <title>::Mr.Gifa fa-Admin::Edit Sub-Category</title>
@endsection
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="horz-layout-basic">Edit Sub-Category</h4>
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal" role="form"
                                              action="{{ route('admin.subcategory.edit.submit') }}" method="post"
